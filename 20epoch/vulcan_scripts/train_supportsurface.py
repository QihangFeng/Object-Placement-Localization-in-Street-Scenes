#!/usr/bin/env python3
"""
train_supportsurface.py  --  Stage 2: SupportSurface model
...
Saves: 02_supportsurface_last.pt / 02_supportsurface_best.pt
"""
...
# ───────────────────────────── dataset (SUPPORTSURFACE VARIANT) ─────
...
class BootplaceSupportSurfaceDataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        # 8. resized label map for semantic features
        ...
        # <<< KEY DIFF: all-ones valid mask (no hard constraint)
...
# ───────────────────────────── training loop (SUPPORTSURFACE VARIANT)
...
def main():
    parser = argparse.ArgumentParser(description="Train SupportSurface model")
    ...
    last_ckpt = save_dir / "02_supportsurface_last.pt"
    best_ckpt = save_dir / "02_supportsurface_best.pt"
